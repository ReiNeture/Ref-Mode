...
new const gszBlockModelAqua[] = "models/blockmaker/bm_block_aqua.mdl";
new const gszBlockModelKanata[] = "models/blockmaker/bm_block_kanata.mdl";
...
new const gszAquaSound[] = "blockmaker/aqua_noise.wav";					//from 'www.wavsource.com/sfx/sfx.htm'
new const gszKanataSound[] = "blockmaker/kanata_noise.wav";					//from 'www.wavsource.com/sfx/sfx.htm'
...
{
	'A', 'B', 'C', 'D', 'I', 'J', 'G', 'H', 'E', 'F', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z'
};
...
public plugin_precache()
{
	...
	gszBlockModels[BM_AQUA] = gszBlockModelAqua;
	gszBlockModels[BM_KANATA] = gszBlockModelKanata;
			...
			while (!feof(f))
			{
				...
				if (strlen(szType) > 0)
				{
					...
					switch (szType[0])
					{
						...
						case 'Y': createBlock(0, BM_AQUA, vVec1, axis, size);
						case 'Z': createBlock(0, BM_KANATA, vVec1, axis, size);
