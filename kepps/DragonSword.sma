...
public plugin_init()
{
	...
	register_concmd("dragonsword", "get_dragonsword", ADMIN_KICK)
}

public plugin_natives()
	register_native("give_user_dsword", "native_give_user_dsword", 1);

public native_give_user_dsword(id)
	get_dragonsword(id)
...
do_attack(Attacker, Victim, Inflictor, Float:fDamage)
{
	...
	fake_take_damage(Attacker, Victim, fDamage*100.0, Inflictor)
}
