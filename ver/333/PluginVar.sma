...
new porn[33][6] //0atk 1speed 2hp 3dodge 4point 5low damage
...
new const dildo_handjob_level[] = { 0, 1, 5, 3, 10, 8, 30, 30, 15, 70 }
...
new const normal_knife_damage[] = {0, 17, 31, 44, 82} //------------------------0725
new const normal_knife_count[] = {170000, 350000, 720000, 9999999} //------------------------0725
